...
all_files <- list.files("../Shared data/EMEP Atmosphere/", recursive = TRUE, full.names = TRUE, pattern = ".nc") %>%
...
Space <- Window_emep(all_files[1,]$File, w = 1, e = 21, s = 58, n = 72)     # Get values to crop a netcdf file spatially at import. 
